...
namespace Offsets
{
	constexpr int32 GObjects          = 0x04C2AC30;
	constexpr int32 AppendString      = 0x01138B20;
	constexpr int32 GNames            = 0x04BEE780;
	constexpr int32 GWorld            = 0x04D6F248;
	constexpr int32 ProcessEvent      = 0x01354EC0;
